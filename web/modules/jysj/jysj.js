...
//				"[data-action=delete]": this.actionDelete,
 	   ...
 	   actionEdit: function(e){
        	...
        	var data = WIS_EMAP_SERV.getData(bs.api.pageModel, 'jysjdr', {WID:id});
...
//    				return {XSBH:el.XSBH, XXX:el.XXX};	//模型主键
		...
		actionImport: function(){
			var params = {"analyse":"NBUGZL.src.com.wisedu.emap.nbugzl.service.TeacherImportAnalyse",
		...
		_initAdvanceQuery: function() {
            var searchData = WIS_EMAP_SERV.getModel(bs.api.pageModel, 'jysjdr', "search");
