define(function(require, exports, module) {
	...
	var bs = {
		api: {
			pageModel: 'modules/xyndgzlhz.do',
...
//			return BH_UTILS.doAjax('../modules/xyndgzlhz/T_PXXX_XSJBXX_SAVE.do', formData);
		},
		del: function(params){
			//TODO 添加删除动作
//			return BH_UTILS.doAjax('../modules/xyndgzlhz/T_PXXX_XSJBXX_DELETE.do', {
